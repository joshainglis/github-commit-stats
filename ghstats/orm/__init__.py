...
meta = MetaData(naming_convention={
    "ix": 'ix_%(column_0_label)gh_session',
    "uq": "uq_%(table_name)s_%(column_0_name)gh_session",
    "ck": "ck_%(table_name)s_%(constraint_name)gh_session",
    "fk": "fk_%(table_name)s_%(column_0_name)s_%(referred_table_name)gh_session",
    "pk": "pk_%(table_name)gh_session"
})
